export default function ActorPageSkeleton() {
  return (
    <main
      className="min-h-full bg-zinc-50 dark:bg-black px-4 py-10"
      aria-busy="true"
      aria-label="Loading actor and movie rankings"
    >
      <output className="sr-only">Loading actor and movie rankings…</output>
